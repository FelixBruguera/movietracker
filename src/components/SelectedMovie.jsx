...
const SelectedMovie = ({ movie, unselect }) => {
  return (
    <div className="flex flex-col gap-3 items-center">
      <Label className="dark:text-stone-400">Movie</Label>
      <div className="flex gap-3 items-center h-10/10 border-1 border-stone-400 dark:border-stone-700 rounded-lg p-3 hover:border-stone-900 transition-all">
